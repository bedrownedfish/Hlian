				...
				<form action="" id="form" >
					...
					<div class="f1">
						<div class="container_1">
							...
							<span class="resiter_btn" id="vcodes">获取验证码</span>
						</div>
					</div>
					...
					<div class="f1">
						<div class="container_1">
							...
							<img src="<?=base_url('public/login/')?>images/register_icon_view_open.png" class="resiter_yan"/>
							<img src="<?=base_url('public/login/')?>images/register_icon_view_close.png" class="resiter_yan resiter_yan1"/>
						</div>
					</div>
					<div class="f1">
						<div class="container_1">
...
$(function(){
	...
	$(".resiter_yan").click(function(){
		$(this).hide();
		$(this).siblings(".resiter_yan1").show();
		$(this).siblings("input").attr("type","text");
	})
	$(".resiter_yan1").click(function(){
		$(this).hide();
		$(this).siblings(".resiter_yan").show();
