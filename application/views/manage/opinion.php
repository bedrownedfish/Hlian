                ...
                <div class="layui-form news_list">
					...
					<tbody class="news_content" id="codeht">
						...
						<tr>
							...
							<td><?=$v['mobile']?></td>
							<td style="color:<?=$v['examine']?"green":"red"?>"><?=$v['examine']?"已处理":"未处理"?></td>
							<td><a class="layui-btn layui-btn-mini news_edit" data-id=<?=$v['id']?>><i class="iconfont icon-edit"></i><?=$v['examine']?"修改回复":"回复"?></a>
							</td>
						</tr>
						<?php endforeach?>
					</tbody>
...
var hurl = "<?=base_url('Kinds/opinion_1')?>"
layui.config({
